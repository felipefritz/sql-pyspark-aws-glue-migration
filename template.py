...
def main():
    ...
    try:
        ...
        # 1 ESPECIFICA aca nuevas variables de args
        args = getResolvedOptions(sys.argv, ['JOB_NAME', 'date', 'table_name', 'interface_output']) 
        ...
        # 2 Declara aca mas atributos de la clase ambiente asociados a los args del job glue como por ejemplo:
        # ambiente.table_name_2 = args['table_name_2']   

        # 3 Si necesitas archivo de entrada:
        # ambiente.interface_input_name = args['input_file']
        # ambiente.interface_routes_input = ambiente.generate_name_routes_file(glue_route='FTP_INPUT')
        
        
        # -------------------------------------------------- 1 OBTENER QUERIES SQL -------------------------------------------------------------------------
        ## Declara tus queries sql como funciones en la clase SQLQueryManager con el decorador @staticmethod y utilizalas asi: sql_query_manager.nombre_query()
        ...
        # -------------------------------------------------- 2 CARGAR DATOS ---------------------------------------------------------------------------------
        ## Puedes cargar datos con PYMYSQL el cual retornara data y column_names, y tambien puedes cargar datos con PYSPARK. Puedes revisar en documentacion/cargar datos
        ...
        ## En esta seccion realiza todos los calculos y procesos para modificar los datos. Puedes revisar los ejemplos en documentacion/transormacion de datos
        ...
        # Revisa la documentacion en insertar datos
